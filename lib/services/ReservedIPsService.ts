...
export class ReservedIPsService extends ApiService {
  /**
   * List All Reserved IPs
   * To list all of the reserved IPs available on your account, send a GET request to `/v2/reserved_ips`.
   * @returns any The response will be a JSON object with a key called `reserved_ips`. This will be set to an array of reserved IP objects, each of which will contain the standard reserved IP attributes
   * @throws ApiError
   */
  public reservedIPsList({
    perPage = 20,
    page = 1,
  }: {
    /**
   ...
   * @returns any The response will be a JSON object with a key called `reserved_ip`. The value of this will be an object that contains the standard attributes associated with a reserved IP.
   * @throws ApiError
   */
  public reservedIPsGet({
    reservedIp,
  }: {
    /**
